...
export async function readall(ctx) {
  ...
  try {
    ...
    return { text: '✅ Todos los mensajes marcados como leídos' };
  } catch (error) {
    return { text: '❌ Error al marcar mensajes como leídos' };
  }
}
