...
export function LoginPage() {
  ...
  const getRoleDescription = (role: string) => {
    switch (role) {
      case 'owner':
        return 'Propietario - Acceso completo al sistema';
      case 'admin':
        return 'Administrador - Gestión de usuarios y configuración';
      case 'colaborador':
        return 'Colaborador - Gestión de contenido y moderación';
      case 'usuario':
        return 'Usuario - Acceso básico al panel';
      default:
        return '';
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Login exitoso',
        description: `Bienvenido al panel de control como ${getRoleDescription(selectedRole)}`,
        status: 'success',
        duration: 3000,
      });
    } catch (error: any) {
            ...
            <VStack spacing={6}>
              <FormControl isRequired>
                ...
                >
                  ...
                  <option value="colaborador">Colaborador - Contenido</option>
