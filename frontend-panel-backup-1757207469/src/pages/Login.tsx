...
const roleOptions = [
  { value: 'creador', label: 'Creador', icon: FaUsers, color: 'blue.500', description: 'Gestión de grupos y contenido' },
        ...
        <CardBody p={8}>
          <VStack spacing={6} align="stretch">
            ...
            <Alert status="info" borderRadius="md">
              <AlertIcon />
              <Box>
                <Text fontWeight="bold" fontSize="sm">Credenciales de prueba:</Text>
                <Text fontSize="xs">
                  <strong>Usuario:</strong> admin | <strong>Contraseña:</strong> admin123<br/>
                  <strong>Usuario:</strong> creador | <strong>Contraseña:</strong> admin123
                </Text>
              </Box>
            </Alert>
