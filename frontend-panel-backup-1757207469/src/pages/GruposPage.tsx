        ...
        <ModalContent>
          ...
          <ModalBody>
            <VStack spacing={4}>
              ...
              {/* Solo para 'addProvider': Selector de grupo proveedor igual al de añadir grupo autorizado */}
              {modalMode === 'addProvider' && !selectedGrupo && (
                <>
                  <Box w="100%">
                    <Text fontSize="lg" fontWeight="bold" mb={3}>
                      Grupos Disponibles del Bot
                      ...
                      <VStack spacing={2} maxH="200px" overflowY="auto" border="1px" borderColor="gray.200" borderRadius="md" p={2}>
                        {gruposDisponibles.map((grupo) => (
                          <Box
                            ...
                            cursor="pointer"
                            _hover={{ bg: 'gray.50' }}
                            bg={formData.jid === grupo.jid ? 'green.50' : 'white'}
                            onClick={() => setFormData({ ...formData, jid: grupo.jid, nombre: grupo.nombre })}
                          >
                            <HStack justify="space-between">
                              <VStack align="start" spacing={1}>
                                <Text fontWeight="bold" fontSize="sm">
              ...
              {/* Para 'authorize', restaurar campos originales si es necesario */}
            </VStack>
          </ModalBody>
