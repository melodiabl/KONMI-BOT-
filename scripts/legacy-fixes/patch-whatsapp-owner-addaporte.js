// Patch script to update owner detection and /addaporte attachment support in backend/full/whatsapp.js
// and extend handleAddAporte() usage. Creates backups with timestamp.
...
function patchWhatsappJs(file) {
  ...
  // 4) getContactName: replace owner tail logic and static JIDs
  src = src.replace(
...
(function main() {
  ...
  const cc = path.join(root, 'backend', 'full', 'commands-complete.js');
  ...
  // Nota: commands-complete.js ya fue actualizado en esta sesión por otra vía
})();
