...
describe('parse', () => {
	...
	it('should parse non-European digits', () => {
		expect(parseNumber('+')).to.deep.equal({ country: 'US', phone: '2122323232' })
	})
	...
	it('should parse phone number extensions', () => {
		...
		// "."
		expect(parseNumber('+78005553535 . 1234', 'RU')).to.deep.equal({
			country : 'RU',
			phone   : '8005553535',
			ext     : '1234'
		})
	...
	it('should parse extensions (long extensions with explicitl abels)', () => {
		...
		expect(parseNumber('03 3316005 xtensin, 12345678901234567890#', 'NZ').ext).to.equal('12345678901234567890')
		expect(parseNumber('03 3316005extension.12345678901234567890', 'NZ').ext).to.equal('12345678901234567890')
		expect(parseNumber('03 3316005 :12345678901234567890', 'NZ').ext).to.equal('12345678901234567890')
